...
# 18175-most-watched-videos-playlist
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-most-watched-videos-playlist.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>most-watched-playlist.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>most-watched-playlist.css</strong>.</td>
    </tr>
  </tbody>
</table>
